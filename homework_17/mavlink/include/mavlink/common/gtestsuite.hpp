...
TEST(common, CELLULAR_STATUS)
{
    ...
    packet_in.lac = 17443;
    packet_in.id = 163;
    packet_in.link_tx_rate = 963498036;
    packet_in.link_rx_rate = 963498244;
    packet_in.cell_tower_id = to_char_array("TUVWXYZA");
    packet_in.band_number = 89;
    packet_in.band_frequency = 220.0;
    packet_in.channel_number = 963499180;
    packet_in.rx_level = 276.0;
    packet_in.tx_level = 304.0;
    packet_in.rx_quality = 332.0;
    packet_in.sinr = 360.0;
    ...
    EXPECT_EQ(packet1.cell_tower_id, packet2.cell_tower_id);
    EXPECT_EQ(packet1.band_number, packet2.band_number);
    EXPECT_EQ(packet1.band_frequency, packet2.band_frequency);
    EXPECT_EQ(packet1.channel_number, packet2.channel_number);
    EXPECT_EQ(packet1.rx_level, packet2.rx_level);
    EXPECT_EQ(packet1.tx_level, packet2.tx_level);
    EXPECT_EQ(packet1.rx_quality, packet2.rx_quality);
    EXPECT_EQ(packet1.sinr, packet2.sinr);
}
...
TEST(common_interop, CELLULAR_STATUS)
{
    ...
    EXPECT_EQ(packet_in.cell_tower_id, packet2.cell_tower_id);
    EXPECT_EQ(packet_in.band_number, packet2.band_number);
    EXPECT_EQ(packet_in.band_frequency, packet2.band_frequency);
    EXPECT_EQ(packet_in.channel_number, packet2.channel_number);
    EXPECT_EQ(packet_in.rx_level, packet2.rx_level);
    EXPECT_EQ(packet_in.tx_level, packet2.tx_level);
    EXPECT_EQ(packet_in.rx_quality, packet2.rx_quality);
    EXPECT_EQ(packet_in.sinr, packet2.sinr);
...
TEST(common_interop, AVAILABLE_MODES)
{
    ...
    mavlink_available_modes_t packet_c {
         963497464, 963497672, 29, 96, 163, "LMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRS", 15
    };
